...
#
## List to store loaded geometries
#loaded_geometries = []
#
## Load each .ply file
#for i in range(2):
#    try:
#        # Attempt to load as TriangleMesh
#        mesh = o3d.io.read_triangle_mesh("output/"+args.img+f"_geometry_{i}.ply")
#        loaded_geometries.append(mesh)
#    except:
#        try:
#            # If failed, attempt to load as LineSet
#            lines = o3d.io.read_line_set("output/"+args.img+f"_geometry_{i}.ply")
#            loaded_geometries.append(lines)
#        except:
#            print(f"Failed to load geometry_{i}.ply")
#
## Visualize loaded geometries
#o3d.visualization.draw_geometries(loaded_geometries, mesh_show_back_face=True)
